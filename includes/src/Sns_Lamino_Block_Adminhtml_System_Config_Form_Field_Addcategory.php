...
class Sns_Lamino_Block_Adminhtml_System_Config_Form_Field_Addcategory extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    public function __construct()
    {
		...
		$this->addColumn('item', array(
            'label' => Mage::helper('adminhtml')->__('Item'),
            'style' => 'width:50px',
            'type' => 'input',
        ));
